...
void testApp::setup(){
	...
	tileStreamer.setupStreamer( 125 , 125 , address , port , ofColor( 0 , 255 , 125 ) ) ; 
	/*
...
void testApp::draw(){
	...
	//ofDrawBitmapStringHighlight ( status , 25 , ofGetHeight() - 55 ) ; 
	ofSetColor( 255 , 255 , 255 ) ;
	videoGrabber.draw ( 25 , 25 ) ; 

	tileStreamer.draw( 25 , ofGetHeight() - 25 - tileStreamer.tileHeight ) ;
}
